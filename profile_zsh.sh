...
# Install package
min_install() {
    sudo apt update && sudo apt install -y tree mc bat duf zsh chrony curl tmux vim htop git build-essential ca-certificates apt-transport-https sysstat ncdu python3-venv python3-pip python3-full jq
