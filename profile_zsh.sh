...
echo "Don't forget execute \033[33m'mnvm install --lts'\033[0m for node js"
echo "Don't forget execute \033[33mpyenv install 3.12 && pyenv global 3.12\033[0m for python"
